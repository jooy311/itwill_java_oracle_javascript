...
public class ModifyInfoFrame extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (src == cancelBtn) {
			...
			} else if(!myworkplace.getText().equals(member.getWorkpalce())) {
				int choice = JOptionPane.showConfirmDialog(this, "근무지 변경시, 여태까지 저장된 내용이 초기화됩니다. 그래도 변경하시겠습니까?", "경고", JOptionPane.OK_CANCEL_OPTION);
