...
//다른 패키지의 클래스를 쉽게 표현하기 위해 import 키워드를 사용하여 선언
// => 클래스명 입력 후 [Ctrl]+[Space]를 누르면 자동으로 import 구현
//[Ctrl]+[Shift]+[O] : import 추가 또는 제거
import site.uniwill.subject.NetworkSubject;
import site.itwill.subject.JavaSubject;
//패키지가 다른 동일한 이름의 클래스는 import 구현 불가능
...
public class SubjectApp {
	public static void main(String[] args) {
		...
		//같은 이름의 클래스가 다른 패키지에 각각 선언된 경우 import 설정 주의 
		JavaSubject subject3=new JavaSubject();
		subject3.display();
		
		//import 구현이 불가능한 클래스인 경우 패키지명을 포함한 클래스명으로 표현
